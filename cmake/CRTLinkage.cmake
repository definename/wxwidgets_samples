if (MSVC)
	...
	message(STATUS "1111 ${BUILD_WITH_STATIC_CRT}")
	message(STATUS "222 ${BUILD_SHARED_LIBS}")
	...
	if (NOT BUILD_SHARED_LIBS AND BUILD_WITH_STATIC_CRT)
		...
		foreach(flag_var
			...
			if (${flag_var} MATCHES "/MD")
				message(STATUS "111111111111111111111111111111111111111111111111111111111111111111111111")
